...
The above project is a result of many hours and a lot of hard work. I am confident the program can be simplified, but I believe it represents well the skills I have developed during my journey at Southern New Hampshire University. While developing the program I utilized the knowledge acquired in previous courses, including an introduction course in SQL databases, the course included handling the databases using Codio, integrading databases in C++ was a brand new concept for me. The program required more knowledge than I had, countless hours were spent researching and trying different approaches before reaching the final result shared on this page. The final program displays my efforts in problem solving and adapting to changes as challenges presented themselves. If additional time was available I would like to have implemented unit testing to ensure the code is working as expected and less issues can be prevented from future updates. 
